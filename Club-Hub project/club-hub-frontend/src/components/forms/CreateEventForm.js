  ...
  return (
    <div className="bg-[#144272] p-6 rounded-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="text-[#c8d8e4] block mb-2">Event Title</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-[#c8d8e4] block mb-2">Date</label>
            <input
              type="date"
              value={formData.date}
          ...
          <div>
            <label className="text-[#c8d8e4] block mb-2">Time</label>
            <input
              type="time"
              value={formData.time}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="text-[#c8d8e4] block mb-2">Capacity</label>
            <input
              type="number"
        ...
        <div>
          <label className="text-[#c8d8e4] block mb-2">Registration Deadline</label>
          <input
            type="date"
